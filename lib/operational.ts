/**
 * ARSAVAYA PMS — operational presentation selectors (PMS-2B).
 *
 ...
 * stay owned by blocksAvailability().
 *
 * Presentation layer for arrivals / stay / departure, dashboard KPIs,
 * reservation filters, status badges and the status-history timeline.
 */
